...
if(r==='transparent')return'transparent';if(e.find(a=>a.value===r)||r)return r;let o=e.find(a=>a.name===t);if(o)return o.value;if(t){
let a=e.map(d=>d.name).join(', ');X.warn(P`
...
var u;let{globals:t,parameters:o}=e,a=(u=t[p])==null?void 0:u.value,d=o[p],i=h(()=>d.disable?'transparent':Q(a,d.values,d.default),[d,a]),n=h(()=>i&&i!=='transparent',[i]),s=e.viewMode==='docs'?`#anchor--${e.id} .docs-story`:'.sb-show-main',c=h(()=>`
      ${s} {
        background: ${i} !important;
        ${D()?'':'transition: background-color 0.3s;'}
      }
    `,[i,s]);return _(()=>{let l=e.viewMode==='docs'?`addon-backgrounds-docs-${e.id}`:'addon-backgrounds-color';if(!n){A(l);return;}Y(l,c,e.viewMode==='docs'?e.id:null);},[n,c,e]),r();
},V=(r,e)=>{
var y;let{globals:t,parameters:o}=e,a=o[p].grid,d=((y=t[p])==null?void 0:y.grid)===!0&&a.disable!==!0,{cellAmount:i,cellSize:n,opacity:s}=a,c=e.viewMode==='docs',u=o.layout===void 0||o.layout==='padded'?16:0,l=a.offsetX??(c?20:u),$=a.offsetY??(c?20:u),f=h(()=>{
let m=e.viewMode==='docs'?`#anchor--${e.id} .docs-story`:'.sb-show-main',E=[`${n*i}px ${n*i}px`,`${n*i}px ${n*i}px`,`${n}px ${n}px`,`${n}px ${n}px`].join(', ');return`
      ${m} {
